from stlib.prefabs.materials.rigid import Rigid
from stlib.prefabs.materials.deformable import Deformable
from stlib.prefabs.geometries.cube import CubeParameters
