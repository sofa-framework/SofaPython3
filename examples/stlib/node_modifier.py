...
def createScene(root):
    ...
    LogoNode.add(NodeModifier, on = [LogoNode], parameters = SimulationSolversParameters(constantSparsity=False))
    ...
    Logo.material.addObject("ConstantForceField", name="ConstantForceUpwards", totalForce=[0, 0, -2.0])
