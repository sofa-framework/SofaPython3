...
class Test(unittest.TestCase):
    ...
    def test_kwargs_constructor(self):
        root = Sofa.Core.Node("root", gravity=[0,0,12.3], activated=False)
        self.assertEqual(root.name.value, "root")
        self.assertEqual(root.gravity.value[0], 0)
        self.assertEqual(root.gravity.value[1], 0)
        self.assertEqual(root.gravity.value[2], 12.3)
        self.assertEqual(root.activated.value, False)
